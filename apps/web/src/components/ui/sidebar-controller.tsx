...
children: ReactNode}) {
  ...
  return (
    <div  className={` w-full   h-screen  sm:bg-none relative z-50 grid grid-cols-[1fr] ${value ? "sm:grid-cols-[200px_1fr] md:grid-cols-[300px_1fr] border-0 " : "sm:grid-cols-[80px_1fr]  "} `}>
      ...
      {value ?
        <div className="  w-full absolute sm:relative inset-0 top-0 z-45 flex justify-center  sm:border sm:border-black/12 sm:dark:border-white/20 ">
      <div className=" absolute hidden sm:block -right-2 z-50 top-2 sm:-right-4">
       ...
       : 
        <div className={` ${value ? "hidden":" hidden sm:block w-full "}  z-45 dark:bg-[hsl(210,3%,15%)] sm:relative sm:border sm:border-black/10 sm:dark:border-r-white/20 sm:h-full `}>
